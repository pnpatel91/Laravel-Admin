                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <form method="post" class="float-left"
                                        action="<?php echo e(route('admin.user.destroy', ['user' => $user->id ])); ?>">
                                        <?php echo csrf_field(); ?>
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Technical Task\resources\views/admin/user/index.blade.php ENDPATH**/ ?>