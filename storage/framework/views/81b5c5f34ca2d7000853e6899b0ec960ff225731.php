    ...
    <div class="row">
        ...
        <div class="col-md-12">
            ...
            <div class="card card-body">
                <form action="<?php echo e(url("admin/hobby/$hobby->id/edit")); ?>" method="post" >
                    <?php echo csrf_field(); ?>
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\blog-laravel-7\resources\views/admin/hobby/edit.blade.php ENDPATH**/ ?>