    ...
    <div class="row">
        ...
        <div class="col-md-12">
            ...
            <div class="card card-body">
                <form id="create_hobby" action="<?php echo e(url('admin/hobby')); ?>" method="post">
                    <?php echo csrf_field(); ?> 
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Technical Task\resources\views/admin/hobby/create.blade.php ENDPATH**/ ?>